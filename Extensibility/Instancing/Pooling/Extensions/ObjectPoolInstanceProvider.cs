    ...
    class ObjectPoolingInstanceProvider : IInstanceProvider
    {
       ...
       private Type instanceType;
        ...
        object IInstanceProvider.GetInstance(InstanceContext instanceContext, Message message)
        {
            ...
            WritePoolMessage("New object created in the pool.");
        ...
        void IInstanceProvider.ReleaseInstance(InstanceContext instanceContext, object instance)
        {
            lock (poolLock)
            {
                ...
                WritePoolMessage("Object returned and added to the pool.");
        ...
        void idleTimer_Elapsed(object sender, ElapsedEventArgs args)
        {
            ...
            lock (poolLock)
            {
                if (activeObjectsCount == 0)
                {
                    ...
                    {
                        WritePoolMessage("Am object is being removed from the pool.");
